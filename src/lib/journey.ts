...
export function getGoals(t: TFunction = fallbackT): Goal[] {
  return [
    ...
    { id: "learn", emoji: "📘", title: t("journey:goals.learn.title"), subtitle: t("journey:goals.learn.subtitle") },
    { id: "voting-day", emoji: "📍", title: t("journey:goals.voting-day.title"), subtitle: t("journey:goals.voting-day.subtitle") },
  ];
}

function stepFaqs(t: TFunction, stepId: string): StepFaq[] {
  const raw = t(`journey:steps.${stepId}.faqs`, { returnObjects: true, defaultValue: [] }) as StepFaq[];
...
export function getJourneySteps(t: TFunction = fallbackT): JourneyStep[] {
  return [
    ...
    { id: "s3", phase: "Register", title: t("journey:steps.s3.title"), shortDesc: t("journey:steps.s3.shortDesc"), longDesc: t("journey:steps.s3.longDesc"), estimate: t("journey:steps.s3.estimate"), deadline: t("journey:steps.s3.deadline"), weight: 18, why: t("journey:steps.s3.why"), consequence: t("journey:steps.s3.consequence"), faqs: stepFaqs(t, "s3"), action: { label: t("journey:steps.s3.action"), href: "https://voters.eci.gov.in/" } },
    { id: "s4", phase: "Register", title: t("journey:steps.s4.title"), shortDesc: t("journey:steps.s4.shortDesc"), longDesc: t("journey:steps.s4.longDesc"), estimate: t("journey:steps.s4.estimate"), weight: 12, why: t("journey:steps.s4.why"), consequence: t("journey:steps.s4.consequence"), action: { label: t("journey:steps.s4.action") } },
    { id: "s5", phase: "Verify", title: t("journey:steps.s5.title"), shortDesc: t("journey:steps.s5.shortDesc"), longDesc: t("journey:steps.s5.longDesc"), estimate: t("journey:steps.s5.estimate"), weight: 10, why: t("journey:steps.s5.why"), consequence: t("journey:steps.s5.consequence"), action: { label: t("journey:steps.s5.action") } },
    { id: "s6", phase: "Verify", title: t("journey:steps.s6.title"), shortDesc: t("journey:steps.s6.shortDesc"), longDesc: t("journey:steps.s6.longDesc"), estimate: t("journey:steps.s6.estimate"), weight: 12, why: t("journey:steps.s6.why"), consequence: t("journey:steps.s6.consequence"), action: { label: t("journey:steps.s6.action") } },
    { id: "s7", phase: "Vote", title: t("journey:steps.s7.title"), shortDesc: t("journey:steps.s7.shortDesc"), longDesc: t("journey:steps.s7.longDesc"), estimate: t("journey:steps.s7.estimate"), deadline: t("journey:steps.s7.deadline"), weight: 12, why: t("journey:steps.s7.why"), consequence: t("journey:steps.s7.consequence"), action: { label: t("journey:steps.s7.action") } },
    { id: "s8", phase: "Vote", title: t("journey:steps.s8.title"), shortDesc: t("journey:steps.s8.shortDesc"), longDesc: t("journey:steps.s8.longDesc"), estimate: t("journey:steps.s8.estimate"), deadline: t("journey:steps.s8.deadline"), weight: 18, why: t("journey:steps.s8.why"), consequence: t("journey:steps.s8.consequence"), checklist: stepList(t, "journey:steps.s8.checklist"), faqs: stepFaqs(t, "s8"), action: { label: t("journey:steps.s8.action") } },
  ];
}
...
export function calcReadiness(completedIds: string[], steps: JourneyStep[]): number {
  ...
  const earned = steps.filter((s) => completedIds.includes(s.id)).reduce((sum, s) => sum + s.weight, 0);
